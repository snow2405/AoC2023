...
{
    char card_values[13] = {'A', 'K', 'Q', 'J', 'T', '9', '8', '7', '6', '5', '4', '3', '2'};
    for (int i = 0; i < 13; i++)
    {
...
bool compareTwoHands(string main_hand, string compare_hand)
{
    ...
    int main_card_ammount[4] = {0, 0, 0, 0};
    int main_j_counter = 0;
    int compare_card_ammount[4] = {0, 0, 0, 0};
    ...
    sort(main_card_ammount, main_card_ammount + 4, greater<int>());
    sort(compare_card_ammount, compare_card_ammount + 4, greater<int>());
