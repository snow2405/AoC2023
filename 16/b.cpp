...
int main()
{
    ...
    cout << "Starting brute force, this may take a while... " << endl;

    for (int counter = 0; counter < input_grid.size(); counter++)
    {
    ...
    for (int counter = 0; counter < input_grid.size(); counter++)
    {
        energized_grid = input_grid;
        tail.clear();
        NextTile(counter, input_grid[0].size() - 1, "<");
    ...
    for (int counter = 0; counter < input_grid[0].size(); counter++)
    {
        energized_grid = input_grid;
        tail.clear();
        NextTile(0, counter, "v");
    ...
    for (int counter = 0; counter < input_grid[0].size(); counter++)
    {
        energized_grid = input_grid;
        tail.clear();
        NextTile(input_grid.size() - 1, counter, "^");
